...
// include: C:\Users\thoma\AppData\Local\Temp\tmpa_mqcd3p.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'raylib-game-template/raylib-game-template.data';
      var REMOTE_PACKAGE_BASE = 'raylib-game-template.data';
...
Module['FS_createPath']("/", "resources", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_raylib-game-template/raylib-game-template.data');

      };
      Module['addRunDependency']('datafile_raylib-game-template/raylib-game-template.data');
    ...
    loadPackage({"files": [{"filename": "/resources/LICENSE", "start": 0, "end": 16}, {"filename": "/resources/ambient.ogg", "start": 16, "end": 2672972, "audio": 1}, {"filename": "/resources/coin.wav", "start": 2672972, "end": 2682480, "audio": 1}, {"filename": "/resources/mecha.png", "start": 2682480, "end": 2684835}], "remote_package_size": 2684835});

  })();

// end include: C:\Users\thoma\AppData\Local\Temp\tmpa_mqcd3p.js
// include: C:\Users\thoma\AppData\Local\Temp\tmpxamm4yej.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\Users\thoma\AppData\Local\Temp\tmpxamm4yej.js
// include: C:\Users\thoma\AppData\Local\Temp\tmpby4s9vya.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach(function(task) {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\Users\thoma\AppData\Local\Temp\tmpby4s9vya.js
...
function findWasmBinary() {
    var f = 'raylib-game-template.wasm';
    if (!isDataURI(f)) {
      return locateFile(f);
    }
    return f;
